<template>
    <h3>Novo vendedor</h3>
    <form class="form needs-validation" style="padding: 1%;" novalidate>
        <hr/>
        <div class="col-4">
            <div>
            ...
            <button class="btn btn-success" type="submit" @click="cadastrarVendedor" style="margin-top: 2%">Cadastrar</button>
        </div>
    </form>
</template>
<script>
